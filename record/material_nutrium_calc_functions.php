<?php
    ...
    function material_calc_nutrium($link, $quantity){
        $material_nutrium_array = array();
                    ...
                    while($nutrium_row = mysqli_fetch_assoc($result2)){
                        foreach($nutrium_row as $col_name=>$value){
                            if($col_name != 'recipe_id' && $col_name != 'name' && $col_name != 'id'){
                                ...
                                if(!array_key_exists($col_name,$material_nutrium_array)){ $material_nutrium_array[$col_name] = 0; }
                                $material_nutrium_array[$col_name] += $value * $quantity_rate;
                            }
                        }
                    }
                }
